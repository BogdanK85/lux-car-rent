...
export const Form = styled.form`
  ...
  @medai screen and (min-width: 1440px) {
    gap: 18px;
  }
`;
...
export const customStyles = {
  ...
  menu: defaultStyles => ({
    ...
    background: 'var(--color-text-button-and-black',
    boxShadow: '0pc 4px 36px 0px rgba(0, 0, 0, 0.02)',
  }),
  ...
  menuList: base => ({
    ...
    padding: '0px',
    height: '244px',
    overflowY: 'auto', // turn on the scroll
    '&::-webkit-scrollbar': {
      width: '8px', // make scroll width
    },
    '&::webkit-scrollbar-thumb': {
      background: 'rgba(18, 20, 23, 0.05)', //scroll color
      borderRadius: '10px', //scroll border radius
    },
  }),
